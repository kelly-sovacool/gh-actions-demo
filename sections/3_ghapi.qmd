...
The GitHub CLI^[<https://cli.github.com/manual/>] (`gh`) is a command-line
...
Let's try automatically adding an issue comment when a label is added to the issue.^[adapted from <https://docs.github.com/en/actions/use-cases-and-examples/project-management/commenting-on-an-issue-when-a-label-is-added>]
