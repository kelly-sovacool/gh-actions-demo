...
[`python-package`](https://github.com/kelly-sovacool/gh-actions-sandbox/tree/main/python-package)
to a new branch your repo.
...
- [Python](https://github.com/CCBR/actions/blob/main/examples/build-python.yml) (CCBR)
- [R](https://github.com/r-lib/actions/blob/v2-branch/examples/check-standard.yaml) (r-lib)