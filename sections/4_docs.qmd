...
Take a look at the example quarto document: [`quarto-report/notebook.qmd`](https://github.com/kelly-sovacool/gh-actions-sandbox/blob/main/quarto-report/notebook.qmd).
...
- [quarto examples](https://github.com/quarto-dev/quarto-actions/tree/main/examples) (Quarto)
- [quarto docs](https://github.com/CCBR/actions/blob/main/examples/docs-quarto.yml) (CCBR)
- [mkdocs](https://github.com/CCBR/actions/blob/main/examples/docs-mkdocs.yml) (CCBR)
- [R Markdown](https://github.com/r-lib/actions/blob/v2-branch/examples/render-rmarkdown.yaml)
